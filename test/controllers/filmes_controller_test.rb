...
class FilmesControllerTest < ActionController::TestCase
  ...
  test "should create filme" do
    assert_difference('Filme.count') do
      post :create, filme: { ator: @filme.ator, genero: @filme.genero, preco: @filme.preco, titulo: @filme.titulo }
    end
  ...
  test "should update filme" do
    patch :update, id: @filme, filme: { ator: @filme.ator, genero: @filme.genero, preco: @filme.preco, titulo: @filme.titulo }
    assert_redirected_to filme_path(assigns(:filme))
  end
